...
(
	...
	LS__CUSTOMER_CITY__CITY_PUSHPIN_LONGITUDE VARCHAR(128),
    LS__CUSTOMER_CITY__CITY_PUSHPIN_LATITUDE VARCHAR(128),
...
(
	...
	foreign key (PRODUCT__PRODUCT_ID) references OUT__PRODUCT(PRODUCT_ID),
	foreign key (PRODUCT__PRODUCT_ID) references OUT__PRODUCT(PRODUCT_ID)
)
;
...
(
	...
	foreign key (PRODUCT__PRODUCT_ID) references OUT__PRODUCT(PRODUCT_ID),
	foreign key (ORDER__ORDER_ID) references OUT__ORDER(ORDER_ID),
	foreign key (CUSTOMER__CUSTOMER_ID) references OUT__CUSTOMER(CUSTOMER_ID),
	foreign key (PRODUCT__PRODUCT_ID) references OUT__PRODUCT(PRODUCT_ID),
	foreign key (ORDER__ORDER_ID) references OUT__ORDER(ORDER_ID),
	foreign key (CUSTOMER__CUSTOMER_ID) references OUT__CUSTOMER(CUSTOMER_ID)
)
